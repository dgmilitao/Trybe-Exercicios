...
// Para isso, você deve utilizar o código abaixo e desenvolver sua lógica a partir dele:
...
// Essa função recebe dois parâmetros: arr, que é o array com o nome das pessoas convidadas, e name,
//  que é o nome a ser verificado na lista de convidados (array names).
...
// Você deve utilizar o array people e desenvolver a sua lógica a partir dele. Para isso:
...
const people = [
    ...
    const verifyAges = (array, minimuAge) => array.every((person) => person.age >= minimuAge);
